...
| ALLOW_PUBLIC_ROOMS                              | Allow rooms open to anyone with the link. Turned off, that level cannot be set, rooms already holding it run as trusted, and unregistered rooms answer 404   | true                                                                                                                                                          |
