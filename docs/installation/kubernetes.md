...
| ALLOW_PUBLIC_ROOMS                              | Allow rooms open to anyone with the link. Turned off, that level is refused wherever it is set, unregistered rooms answer 404, and the backend moves public rooms and user defaults to trusted as it starts, for good | true                                                                                                                                                          |
