...
| RESOURCE_ALLOWED_ACCESS_LEVELS                  | Access levels a room owner or administrator may set, on create and on update. A room at a level removed later is entered at the next stricter one allowed, and unregistered rooms are refused while public is out of the list    | public,trusted,restricted                                                                                                                                     |
