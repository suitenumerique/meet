...
| ALLOW_PUBLIC_ROOMS                              | Allow rooms anyone can join with the link. Turned off, that access level is refused on create and on update, a room already set to it runs as trusted, and unregistered rooms are refused    | true                                                                                                                                                          |
