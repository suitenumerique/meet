...
| ALLOW_PUBLIC_ROOMS                              | Allow rooms open to anyone with the link. Turned off, the room APIs refuse that level, rooms holding it run as trusted, and unregistered rooms answer 404    | true                                                                                                                                                          |
