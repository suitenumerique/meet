...
│   ├── addons/         # Eg. Calendar add-ons support
...
│   ├── i18n/ / locales/# Translation setup and JSON files (fr, en, de, nl, …)
...
Tech stack: React 18, TypeScript, Vite, LiveKit React SDK, React Aria (Adobe), Valtio, TanStack Query, i18next.

See `src/frontend/src/features/` directly for the current feature list, as it changes frequently.
